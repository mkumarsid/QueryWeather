...
def generate_synthetic_weather_data(start_date: str, end_date: str, output_file: str):
    ...
    weather_descriptions = ["clear sky", "light rain", "overcast", "fog", "sunny", "cloudy"]
    ...
    print(f"✅ Generated {len(df)} rows of synthetic weather data for {len(stations)} stations.")
    print(f"📄 Saved to {output_file}")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate synthetic weather data for Dublin and Galway.")
    ...
    parser.add_argument("--out", type=str, default="synthetic_weather.csv", help="Output CSV file name")
